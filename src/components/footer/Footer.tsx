        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <i className="fas fa-map-marker-alt mt-1 mr-3"></i>123 Green St,
                Flora City, USA
              </li>
              ...
              <li className="flex items-center">
                <i className="fas fa-phone mr-3"></i>+1 (123) 456-7890
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              ...
              />
              <button className="bg-brand-accent text-brand-green font-bold py-2 px-4 hover:bg-opacity-90">
                Sub
              </button>
            </div>
          </div>
